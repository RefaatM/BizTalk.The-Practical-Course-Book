...
namespace PractBTS.ErrorCollection.ErrorHandler
{
    ...
    [Microsoft.XLANGs.BaseTypes.PortTypeOperationAttribute(
        ...
        new System.Type[]{
            typeof(PractBTS.ErrorCollection.ErrorHandler.__messagetype_System_Xml_XmlDocument)
        },
        new string[]{
        }
    )]
    ...
    [System.SerializableAttribute]
    sealed public class __PractBTS_ErrorCollection_ErrorHandler_EHErrorSchema__ : Microsoft.XLANGs.Core.XSDPart
    {
        private static PractBTS.ErrorCollection.ErrorHandler.EHErrorSchema _schema = new PractBTS.ErrorCollection.ErrorHandler.EHErrorSchema();

        public __PractBTS_ErrorCollection_ErrorHandler_EHErrorSchema__(Microsoft.XLANGs.Core.XMessage msg, string name, int index) : base(msg, name, index) { }
    ...
    [Microsoft.XLANGs.BaseTypes.MessageTypeAttribute(
        ...
        "PractBTS.ErrorCollection.ErrorHandler.EHErrorSchema",
        new System.Type[]{
            typeof(PractBTS.ErrorCollection.ErrorHandler.EHErrorSchema)
        },
        new string[]{
            "part"
        },
        new System.Type[]{
            typeof(__PractBTS_ErrorCollection_ErrorHandler_EHErrorSchema__)
        },
        0,
        @"http://www.MoustafaRefaat.com/PractBTS/ErrorCollection/ErrorMessage#ErrorMessage"
    )]
    [System.SerializableAttribute]
    sealed public class __messagetype_PractBTS_ErrorCollection_ErrorHandler_EHErrorSchema : Microsoft.BizTalk.XLANGs.BTXEngine.BTXMessage
    {
        public __PractBTS_ErrorCollection_ErrorHandler_EHErrorSchema__ part;

        private void __CreatePartWrappers()
        {
            part = new __PractBTS_ErrorCollection_ErrorHandler_EHErrorSchema__(this, "part", 0);
            this.AddPart("part", 0, part);
        }

        public __messagetype_PractBTS_ErrorCollection_ErrorHandler_EHErrorSchema(string msgName, Microsoft.XLANGs.Core.Context ctx) : base(msgName, ctx)
        {
    ...
    [Microsoft.XLANGs.BaseTypes.PortTypeOperationAttribute(
        "Operation_1",
        new System.Type[]{
            typeof(PractBTS.ErrorCollection.ErrorHandler.__messagetype_PractBTS_ErrorCollection_ErrorHandler_EHErrorSchema)
        },
        new string[]{
        }
    )]
    ...
    sealed internal class ErrorMsgPortType : Microsoft.BizTalk.XLANGs.BTXEngine.BTXPortBase
    {
        ...
        (
            ...
            typeof(__messagetype_PractBTS_ErrorCollection_ErrorHandler_EHErrorSchema),
            null,
            new System.Type[]{},
            new string[]{}
        );
    ...
    //#line 396 "C:\Development\BTSPracCourse\BTS2009\BTSPracCourse\PractBTS.ErrorCollection.ErrorHandler\ErrorHandlerLogic.odx"
    ...
    [Microsoft.XLANGs.BaseTypes.ServicePortsAttribute(
        ...
        new System.Type[] {
            typeof(PractBTS.ErrorCollection.ErrorHandler.ErrorsPortType),
            typeof(PractBTS.ErrorCollection.ErrorHandler.PortType_DynamixSend),
            typeof(PractBTS.ErrorCollection.ErrorHandler.ErrorMsgPortType)
        },
        new System.String[] {
            "ErrorsPort",
            "ArchiveDynmicPort",
...
<Messages>
	<MsgInfo><name>ErrorReportMsg</name><part>part</part><schema>PractBTS.ErrorCollection.ErrorHandler.EHErrorSchema</schema><direction>Out</direction></MsgInfo>
</Messages>
</TrkMetadata>
...
";
        ...
        public class __ErrorHandlerLogic_1 : Microsoft.XLANGs.Core.ExceptionHandlingContext
        {
            ...
            public __messagetype_PractBTS_ErrorCollection_ErrorHandler_EHErrorSchema __ErrorReportMsg;
        ...
        public Microsoft.XLANGs.Core.StopConditions segment2(Microsoft.XLANGs.Core.StopConditions stopOn)
        {
            ...
            case 30:
                ...
                goto case 31;
            case 31:
                ArchiveDynmicPort.SetPropertyValue(typeof(Microsoft.XLANGs.BaseTypes.Address), @"file://C:\PractBTS\ErrorCollection\DataFolders\BadMessages\" + (System.String)__ctx1__.__ErrorMsg.GetPropertyValueThrows(typeof(BTS.MessageID)) + ".bad");
            ...
            case 42:
                {
                    __messagetype_PractBTS_ErrorCollection_ErrorHandler_EHErrorSchema __ErrorReportMsg = new __messagetype_PractBTS_ErrorCollection_ErrorHandler_EHErrorSchema("ErrorReportMsg", __ctx1__);
